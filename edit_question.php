                            ...
                            <div class="block-content collapse in">
							    ...
							    <form class="form-horizontal" method="post">
									...
									<!-- 	<div class="control-group">
										...
										<div id="opt11">
<?php
	$sqlz = mysqli_query($conn,"SELECT * FROM quiz_question WHERE quiz_question_id = ".$_GET['quiz_question_id']."");


$answer_quiz = mysqli_query($conn,"SELECT * FROM answer WHERE quiz_question_id = ".$_GET['quiz_question_id']."");
...
<div id="opt12">
	...
	<input name="correctt" <?php if($row['answer'] == 'False'){ echo 'checked'; }?> value="F" type="radio">False<br /><br />
		...
		mysqli_query($conn,"update quiz_question set question_text = '$question', date_added= NOW(), answer = '".$_POST['correctt']."', question_type_id = '$type' where quiz_question_id = 67 ")or die(mysqli_error());
